...
(function (root, factory) {
    ...
    var validTransforms = ['transform','translateX', 'translateY', 'translateZ', 'rotate', 'rotateX', 'rotateY', 'rotateZ', 'scale', 'scaleX', 'scaleY', 'scaleZ', 'skewX', 'skewY'];
    ...
    var getPropertiesValues = function(target, prop, value, i) {
        ...
        var fromValue = (values.length > 1) ? values[0] : getInitialTargetValue(target, prop);
        var toValue = (values.length > 1) ? values[1] : values[0];
            ...
            for (var t in transforms) {
                ...
                for(var i in mods){
                    ...
                    if(mods[i].search("X") !== -1){
                        index = 0;
                    }else if(mods[i].search("Y") !== -1){
                        index = 1;
                    }else if(mods[i].search("Z") !== -1){
                        index = 2;
                    }
